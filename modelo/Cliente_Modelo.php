...
class Cliente_Modelo
{
    ...
    public static function updateClienteDeshabilitar($cliente, $id)
    {
        Database::queryChange("UPDATE persona set PER_ESTADO=? where PER_ID=?", array($cliente["PER_ESTADO"], $id));
    }
