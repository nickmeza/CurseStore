        ...
        <nav class="nav_menu" id="nav-menu">
            ...
            <ul class="nav_list">
                ...
                ?>
                    ...
                    <li class="nav_item"><input type="text" name="" id="" placeholder="búsqueda" onkeydown="search(this)" value="<?php echo $buscador ?>"></li>
                <?php } else { ?>
                    <li class="nav_item"><input type="text" name="" id="" placeholder="búsqueda" onkeydown="search(this)"></li>
                <?php } ?>
                <li class="nav_item"><a href="<?php echo $GLOBALS['BASE_URL'] ?>" class="nav_link">Inicio</a></li>
                <li class="nav_item"><a href="<?php echo $GLOBALS['BASE_URL'] ?>nosotros" class="nav_link">Contáctanos</a></li>
                <li class="nav_item" style="display: flex;"><a href="<?php echo $GLOBALS['BASE_URL'] ?>carrito" class="nav_link contador">
